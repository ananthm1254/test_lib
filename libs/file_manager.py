...
class FileManager:
    ...
    def erase_page(self, block_address=None, page_address=None, resp_qid=None, args=None):
        ...
        if utils.erase_direct(self.lib, args=args):
            ...
            raise TestException("Erase failed at Block: {} and Page : {}".format(args["block_address"],
                                                                                 args["page_address"]))
    ...
    def write_to_page(self, block_address=None, page_address=None, resp_qid=None, buff_ptr=None, args=None):
        ...
        if utils.write_direct(self.lib, args=args):
            ...
            raise TestException("Write failed at Block: {} and Page : {}".format(args["block_address"],
                                                                                 args["page_address"]))

    def read_one_chunk(self, block_address=None, page_address=None, offset=None,
                       resp_qid=None, buff_ptr=None, args=None):
        if args is None:
            args = {
                "block_address": block_address,
                "page_address": page_address,
        ...
        if ret:
            ...
            raise TestException("Read failed at Block: {}, Page : {} and Offset: {}".format(args["block_address"],
                                                                                            args["page_address"],
                                                                                            args["offset"]))
